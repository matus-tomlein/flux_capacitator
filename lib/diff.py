...
if __name__ == '__main__':
	...
	content_a = check_output(['ruby', 'lib/get_update_content.rb', a])
	content_b = check_output(['ruby', 'lib/get_update_content.rb', b])
	print textDiff(str(content_a), str(content_b))
